...
$app->group('/{project}', function () use ($middleware) {
    ...
    $this->group('/custom', function () {
        $endpointsList = \Directus\get_custom_endpoints('../www/directus/extensions/custom/endpoints');
    ...
    $this->group('/pages', function () {
        $endpointsList = \Directus\get_custom_endpoints('../www/directus/extensions/core/pages', true);
    ...
    $this->group('/interfaces', function () {
        $endpointsList = \Directus\get_custom_endpoints('../www/directus/extensions/core/interfaces', true);
