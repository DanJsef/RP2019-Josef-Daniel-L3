...
class CoreServicesProvider
{
    ...
    protected function getExternalAuth()
    {
        return function (Container $container) {
            ...
            $coreSso = \Directus\get_custom_x('auth', '../www/directus/extensions/core/auth', true);
            $customSso = \Directus\get_custom_x('auth', '../www/directus/extensions/custom/auth', true);
    ...
    protected function getMailView()
    {
        return function (Container $container) {
            ...
            return new Twig([
                $basePath . '/../www/directus/extensions/custom/mail',
                $basePath . '/src/mail'
            ]);
        };
    }
