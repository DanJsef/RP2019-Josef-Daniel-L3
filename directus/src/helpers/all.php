...
if (!function_exists('register_extensions_hooks')) {
    ...
    function register_extensions_hooks(Application $app)
    {
        register_hooks_list(
            $app,
            get_custom_hooks('../www/directus/extensions/custom/hooks')
        );

        register_hooks_list(
            $app,
            get_custom_hooks('../www/directus/extensions/core/pages', true)
        );

        register_hooks_list(
            $app,
            get_custom_hooks('../www/directus/extensions/core/interfaces', true)
        );
    }
}
